    ...
    return (
        <div className="bg-white min-h-screen flex flex-col">
            <main className="flex-1 w-full max-w-7xl mx-auto px-2 md:px-8 py-8">
                ...
                <div className="text-xs text-gray-500 mb-4">Last updated November 13, 2023</div>
                <div className="space-y-6 text-sm">
                    <section>
                        <h3 className="font-bold mb-2">1. Agreement to Terms</h3>
                        <p>1.1 These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and Promax UK, located at Unit 7, Rear of 151, Hertford Road, London, London EN3 5JG, United Kingdom (we, us), concerning your access to and use of the Brand4print (<a href="http://www.brand4print.co.uk" className="text-[#7000fe] underline">http://www.brand4print.co.uk</a>) website as well as any related applications (the Site).</p>
                        ...
                        <p>1.5 Our site is directed to people residing in the United Kingdom. The information provided on the Site is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country.</p>
                        ...
                        <ul className="list-disc ml-6">
                            <li>Our Acceptable Use Policy <a href="https://www.brand4print.co.uk/privacy-policy/" className="text-[#7000fe] underline">https://www.brand4print.co.uk/privacy-policy/</a>, which sets out the permitted uses and prohibited uses of the Site. When using the Site, you must comply with this Acceptable Use Policy.</li>
                        </ul>
                    </section>
                    <section>
                        <h3 className="font-bold mb-2">2. Acceptable Use</h3>
                        <p>2.1 Our full Acceptable Use Policy <a href="https://www.brand4print.co.uk/privacy-policy/" className="text-[#7000fe] underline">https://www.brand4print.co.uk/privacy-policy/</a>, sets out all the permitted uses and prohibited uses of this site.</p>
                    ...
                    <section>
                        <h3 className="font-bold mb-2">3. Information you provide to us</h3>
                        ...
                        <p>If you know or suspect that anyone other than you knows your user information (such as an identification code or user name) and/or password you must promptly notify us at info@brand4print.co.uk.</p>
                    ...
                    <section>
                        ...
                        <p>4.6 If you wish to complain about User Content uploaded by other users please contact us at info@brand4print.co.uk or use the take down or report button.</p>
                    </section>
                    <section>
                        <h3 className="font-bold mb-2">5. Our content</h3>
                    ...
                    <section>
                        ...
                        <ul className="list-disc ml-6">
                            <li>We will not be liable to you for any loss or damage, whether in contract, tort (including negligence), breach of statutory duty, or otherwise, even if foreseeable, arising under or in connection with: use of, or inability to use, our Site/Services; or use of or reliance on any content displayed on our Site.</li>
                            <li>In particular, we will not be liable for: loss of profits, sales, business, or revenue; business interruption; loss of anticipated savings; loss of business opportunity, goodwill or reputation; or any indirect or consequential loss or damage.</li>
                        </ul>
                    ...
                    <section>
                        <h3 className="font-bold mb-2">9. Term and Termination</h3>
                        <p>9.1 These Terms and Conditions shall remain in full force and effect while you use the Site or Services or are otherwise a user of the Site, as applicable. You may terminate your use or participation at any time, for any reason, by following the instructions for terminating user accounts in your account settings, if available, or by contacting us at info@brand4print.co.uk.</p>
                        ...
                        <p>9.3 If we terminate or suspend your account for any reason set out in this Section 9, you are prohibited from registering and creating a new account under your name, a fake or borrowed name, or the name of any third party, even if you may be acting on behalf of the third party. In addition to terminating or suspending your account, we reserve the right to take appropriate legal action, including without limitation pursuing civil, criminal, and injunctive redress.</p>
                    </section>
                    <section>
                        <h3 className="font-bold mb-2">10. General</h3>
                        ...
                        <p>10.2 These Terms and Conditions and any policies or operating rules posted by us on the Site or in respect to the Services constitute the entire agreement and understanding between you and us.</p>
                        <p>10.3 Our failure to exercise or enforce any right or provision of these Terms and Conditions shall not operate as a waiver of such right or provision.</p>
                        <p>10.4 We may assign any or all of our rights and obligations to others at any time.</p>
                        <p>10.5 We shall not be responsible or liable for any loss, damage, delay or failure to act caused by any cause beyond our reasonable control.</p>
                        <p>10.6  If any provision or part of a provision of these Terms and Conditions is unlawful, void or unenforceable, that provision or part of the provision is deemed severable from these Terms and Conditions and does not affect the validity and enforceability of any remaining provisions.</p>
                        <p>10.7 There is no joint venture, partnership, employment or agency relationship created between you and us as a result of these Terms and Conditions or use of the Site or Services.</p>
                        <p>10.8 For consumers only – Please note that these Terms and Conditions, their subject matter and their formation, are governed by English law. You and we both agree that the courts of England and Wales will have exclusive jurisdiction expect that if you are a resident of Northern Ireland you may also bring proceedings in Northern Ireland, and if you are resident of Scotland, you may also bring proceedings in Scotland. If you have any complaint or wish to raise a dispute under these Terms and Conditions or otherwise in relation to the Site please follow this link <a href="http://ec.europa.eu/odr" className="text-[#7000fe] underline">http://ec.europa.eu/odr</a>.</p>
                        <p>10.9 For business users only – If you are a business user, these Terms and Conditions, their subject matter and their formation (and any non-contractual disputes or claims) are governed by English Law. We both agree to the exclusive jurisdiction of the courts of England and Wales.</p>
                        <p>10.10 A person who is not a party to these Terms and Conditions shall have no right under the Contracts (Rights of Third Parties) Act 1999 to enforce any term of these Terms and Conditions.</p>
                        <p>10.11 In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at info@brand4print.co.uk or by post to:</p>
                        <p>Promax UK<br />Unit 7, Rear of 151, Hertford Road<br />London, London EN3 5JG<br />United Kingdom</p>
                    </section>
                </div>
            </main>
        </div>
